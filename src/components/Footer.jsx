...
function Footer() {
	...
	return (
		<div className="w-screen h-[100vh] bg-ivory fixed top-0 small:relative z-0  p-10 flex flex-col justify-center items-center font-mada text-ivory ">

			<div className="bg-ivory small:hidden w-[10vw] h-[10vh] absolute top-0 -right-[2.5vw] small:-right-[2.5vh] z-30 rotate-45  small:h-[10vw] small:w-[10vh]"></div>
